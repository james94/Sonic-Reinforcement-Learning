# contains step_model, train_model, training function save/load weights
# Runner (generates mb of experience)
...
class Model(object):
    ...
    def __init__(self,
            ...
            """
            Calculate the loss
            Total loss = Policy gradient loss - entropy * entropy coefficient + Value coefficient * value
            """
            # Policy loss
            # Output -log(pi)
...
class Runner(AbstractEnvRunner):
    ...
    def run(self):
        ...
        for n in range(self.nsteps):
            ...
            # Append the values calaculated into the mb
        ...
        for t in reversed(range(self.nsteps)):
            ...
            if t == self.nsteps - 1:
                ...
                #       delta = R - V(s) (because self.gamma * nextvalues * n)
                # else (not done)
